...
<form method="post" action="${ctx}/w/consents/select">
    ...
    <div class="d-content">
     	<div class="d-close d-table">
          ...
          <c:choose>
	           	...
	           	<div class="d-content">CI</div>
						</c:when>
						<c:otherwise>
	           	<div class="d-content">전자서명, CI, 인증서, 전송요구서</div>
						</c:otherwise>
					</c:choose>
     		</div>
      </div>
  ...
  <div class="d-summary-head">
    <div class="d-content">
    귀하는 개인(신용)정보 제공에 관한 동의를 거부하실 수 있습니다. 다만, 개인(신용)정보의 제공에 관한 동의는 마이데이터서비스 가입현황 안내 및 전송요구내역 통합조회 서비스와 직접적으로 관련된 필수적 사항이므로 아래의 사항에 동의하셔 야만 마이데이터서비스 가입현황 안내 및 전송요구내역 통합조회 서비스의 제공이 가능합니다.
    </div>
  </div>
  <div class="d-summary-main">
    <div class="d-summary fs-18">
  ...
  <div class="d-summary d-summary-agree">
    ...
    <div class="d-content">
      <div class="d-close d-table">
        <div>
	        <div class="d-subtitle">전송요구 내역정보</div>
          <div class="d-content">회원 가입여부, 서비스목록수, 서비스목록, 클라이언트ID, 전송요구내역수, 전송요구내역목록, 정보제공자 기관코드, 권한 범위, 전송요구일자, 전송요구종료시점</div>
        </div>
      </div>
      <div class="d-radio">
