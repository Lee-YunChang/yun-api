    ...
    <div class="d-content">
      ...
      <div class="d-radio">
        ...
        <div>
            ...
            <label class="custom-control-label mr-32" for="agree_5_1_y">동의함</label>
            <input type="radio" value="N" name="agree_5_1" id="agree_5_1_n"/>
            <label class="custom-control-label" for="agree_5_1_n">동의하지 않음</label>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="d-content">
      ...
      <div class="d-radio">
        ...
        <div>
            ...
            <label class="custom-control-label mr-32" for="agree_5_2_y">동의함</label>
            <input type="radio" value="N" name="agree_5_2" id="agree_5_2_n"/>
            <label class="custom-control-label" for="agree_5_2_n">동의하지 않음</label>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="d-content">
      ...
      <div class="d-radio">
        ...
        <div>
            ...
            <label class="custom-control-label mr-32" for="agree_5_3_y">동의함</label>
            <input type="radio" value="N" name="agree_5_3" id="agree_5_3_n"/>
            <label class="custom-control-label" for="agree_5_3_n">동의하지 않음</label>
        </div>
      </div>
    </div>
  </div>
